...
<head>
    ...
    <body>
        ...
        <section class="default-banner active-blog-slider">
                <div class="item-slider relative" style="background: url(landing/img/slider1.jpg);background-size: cover;">
                        ...
                        <div class="row fullscreen justify-content-center align-items-center">
                            <div class="col-md-10 col-12">
                                <div class="banner-content text-center">
                                    ...
                                    <a href="{{ route('login') }}" class="text-uppercase header-btn">Discover Now</a>
                                </div>
                            </div>
                ...
                <div class="item-slider relative" style="background: url(landing/img/slider2.jpg);background-size: cover;">
                    <div class="overlay" style="background: rgba(0,0,0,.3)"></div>
                    <div class="container">
                        <div class="row fullscreen justify-content-center align-items-center">
                            <div class="col-md-10 col-12">
                ...
                <div class="item-slider relative" style="background: url(landing/img/slider3.jpg);background-size: cover;">
                    <div class="overlay" style="background: rgba(0,0,0,.3)"></div>
                    <div class="container">
                        <div class="row fullscreen justify-content-center align-items-center">
                            <div class="col-md-10 col-12">
